...
class AnomalyAlertSerializer(serializers.ModelSerializer):
    ...
    owner_name = serializers.CharField(source="quotation.created_by.full_name", read_only=True, default=None)
    total_amount = serializers.DecimalField(source="quotation.total_amount", max_digits=12, decimal_places=2, read_only=True, default=None)
